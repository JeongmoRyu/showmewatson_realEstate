...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_bptc7wc5t9qe57nk56riv5hal` (`auth_id`)
...
INSERT INTO `users` VALUES ('u_000000000000','kakao_2941928004','kakao','tmpFcmToken','\0','\0','password','2023-08-16 00:00:00.000000','user','zeomzzz');
