...
DROP TABLE IF EXISTS `sale_infos`;
...
--
-- Dumping data for table `sale_infos`
--

LOCK TABLES `sale_infos` WRITE;
/*!40000 ALTER TABLE `sale_infos` DISABLE KEYS */;
/*!40000 ALTER TABLE `sale_infos` ENABLE KEYS */;
UNLOCK TABLES;
