...
import com.watson.auth.realtor.service.AgencyService;
...
public class AdminController {
    ...
    @PostMapping("/realtor")
    public void realtorSignup(@RequestPart MultipartFile file, @RequestPart RealtorSignupRequest realtorSignupRequest) {
