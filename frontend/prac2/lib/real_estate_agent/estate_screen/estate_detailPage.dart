...
class EstateDetail extends StatefulWidget {
  ...
  EstateDetail({this.houseId = 0});

  @override
  _EstateDetailState createState() => _EstateDetailState();
}
                ...
                Row(
                  children: [
                    ...
                    ElevatedButton(
                        ...
                        onPressed: () => context.push('/estate_notice_write/${widget.houseId}'),
                        child: const Row(
                          children: [
